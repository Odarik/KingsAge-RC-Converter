...
document.addEventListener('load', function(event) {
	...
	if ((/register/.test(location.href))&&!(/agreed/.test(location.href))){
		if (langueaff=='francais'){
			document.querySelector('.align_gauche').innerHTML='<br><h2 class="u">Conditions d&apos;utilisation du forum</h2>
			...
			- si vous diffusez des informations provenant d&apos;un autre site web<br>, vérifiez auparavant si le site en question ne vous l&apos;interdit pas. Mentionnez l&apos;adresse du site en question par respect du travail de ses administrateurs !<br>
			- merci de poster vos messages une seule fois. Les répétitions sont désagréables et inutiles !<br>
			- merci de faire un effort sur la grammaire et l&apos;orthographe. Style SMS déconseillé !<br><br>
			...
			<br><br>
			<span style="color:red">En cliquant sur le bouton &apos; J&apos;accepte &apos; ci-dessous :<br>
			...
			- vous accordez aux modérateurs de ce forum le droit de supprimer, déplacer ou éditer n&apos;importe quel sujet de discussion à tout moment.</span><br><br><br><div align="center"><a class="genmed" href="/register?agreed=true&amp;step=2">J&apos;accepte le règlement</a><br><br><a class="genmed" href="/">Je n&apos;accepte pas le règlement</a></div><br>';
		...
		if (langueaff=='anglais'){
			document.querySelector('.align_gauche').innerHTML='<br><h2 class="u">Forum Terms of service</h2>The moderators of this forum will try hard to edit or remove reprehensible messages as soon as possible. However, it is impossible for them to review all the messages. You thus admit that all the messages posted on this forum express the sight and opinion of their respective authors and not those of the moderators or the Webmaster (except messages posted by them) and consequently, they cannot be held responsible of the discussions.
			 <br><br>This forum uses cookies to store information on your computer. These cookies will not contain any personal information; they are only used to improve comfort while browsing. The address e-mail is only used in order to confirm the details of your registration as your password (and also to send you back your password if you forget it). 
			<br><br>- Aggressive or slanderous messages, as well as personal insults and critics, the coarseness and vulgarities, and more generally any message contravening the French laws are prohibited.
			<br>- Messages who promote - or evoke - illegal practices are prohibited.<br>- If you post informations which come from another site<br>, look first if the site in question doesn&apos;t forbid it. Show the address of the site in question in order to respect the work of their administrators!<br>- Please post your messages only once. The repetitions are unpleasant and useless! 
			<br>- Please make an effort on grammar and spelling. SMS-style language (ex: r u sk8ing?) is not advised!
			<br><br>Any message contravening the listing above will be edited or removed without additional notice or justification within deadlines which will depend on the availability of the moderators. Any abuse will involve the cancellation of the registration. Internet is neither an anonymous space, nor a space of no-right! We reserve ourselves the possibility of informing your access provider and/or the legal authorities of any malevolent behavior. An IP address of each poster is recorded in order to help us to make you respect these conditions.
			<br><br><span style="color:red">By clicking on " I agree to these terms " below:<br>- You acknowledge to have fully read these current rules;<br>- You commit yourself to respect unreservedly these current rules;<br>- You grant the moderators of this forum the right to delete, move or edit any discussion subject at any moment.</span><br><br><br><div align="center"><a class="genmed" href="/register?agreed=true&amp;step=2">I Agree to these terms</a><br><br><a class="genmed" href="/">I do not agree to these terms</a></div><br>';
